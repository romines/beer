...
module.exports = functions.https.onRequest((req, res) => {
  ...
  if (!req.body.messageBody) {
    ...
    //
    //   request.get('https://maker.ifttt.com/trigger/arrival/with/key/xxxx', function (error, res, body) {
    //     console.log('error:', error); // Print the error if one occurred
    //     console.log('statusCode:', res && response.statusCode); // Print the response status code if a response was received
