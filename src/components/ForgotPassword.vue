<template>
  <div class="forgot-password">
    ...
    <div class="main">
      <div class="card">
        <div class="card-header"><p class="card-header-title">Reset Password</p></div>
          ...
          <div class="field">
            <p class="control has-icons-left has-icons-right">
              ...
              <span
                ...
                :class="email && emailIsValid(email) ? 'has-text-success' : 'has-text-grey-lighter'"
              >
          ...
          <div class="field">
            <p class="control">
              <button
                ...
                @click="triggerReset"
                :disabled="!email || !emailIsValid(email)"
              >
                Submit
              </button>
            </p>
        ...
        <footer class="card-footer">
          <p class="card-footer-item">
            <span> <router-link to="/login">Login</router-link> instead </span>
          </p>
        </footer>
      </div>
    </div>
